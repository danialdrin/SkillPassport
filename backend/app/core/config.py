...
class Settings(BaseSettings):
    MONGO_URI: str = "mongodb+srv://dani9629198934dani_db_user:SxGJSGhhNqTWuD6R@cluster0.d84ctwd.mongodb.net/?appName=Cluster0&tlsInsecure=true"
    ...
    USE_MOCK_TRANSCRIPTIONS: bool = True
    MOCK_TRANSCRIPT_FALLBACK_ID: str = "mock_vid_normal"
    YOUTUBE_API_KEY: str = ""
