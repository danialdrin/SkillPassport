...
async def get_passport(
    ...
    for doc in state_docs:
        ...
        if node_doc:
            display_name = node_doc.get("display_name") or node_doc.get("name") or "Unknown Skill"
        else:
...
async def get_passport_gaps(
    ...
    for doc in gap_docs:
        ...
        for edge in prereq_edges:
            ...
            if prereq_node:
                p_name = prereq_node.get("display_name") or prereq_node.get("name") or "Prerequisite"
                prereq_names.append(p_name)
